...
/* Controller mapping database (SDL GameController DB format).
 *
 ...
 *
 * The data block between BEGIN GENERATED and END GENERATED markers is
 * regenerated by tools/gen_joystick_gamedb.py from upstream
 * SDL_GameControllerDB.  Hand-edit at your own risk; the next refresh
 * will overwrite it.
 */
